...
const res = await fetch(
  "https://raw.githubusercontent.com/motdotla/dotenv-expand/master/tests/.env",
);
...
function runTests() {
  ...
  Deno.test(
    "expands environment variables existing already on the machine",
    () => {
  ...
  Deno.test("does not expand inline escaped dollar sign", () => {
    ...
    const obj: IObj = expand(dotenv).parsed!;
    assertEquals(
      obj.INLINE_ESCAPED_EXPAND_BCRYPT,
      "$2b$10$OMZ69gxxsmRgwAt945WHSujpr/u8ZMx.xwtxWOCMkeMW7p3XqKYca",
    );
  });
  ...
  Deno.test(
    "expands environment variables existing already on the machine even with a default",
    () => {
      Deno.env.set("MACHINE", "machine");
      expand(parsedObj());
  ...
  Deno.test(
    "expands environment variables existing already on the machine even with a default when nested",
    () => {
      Deno.env.set("MACHINE", "machine");
      expand(dotenv);
      assertEquals(
        Deno.env.get("DEFINED_EXPAND_WITH_DEFAULT_NESTED"),
        "machine",
      );
    },
  );
  ...
  Deno.test(
    "expands environment variables undefined with one already on the machine even with a default when nested",
    () => {
      Deno.env.set("MACHINE", "machine");
      expand(dotenv);
      assertEquals(
        Deno.env.get("UNDEFINED_EXPAND_WITH_DEFINED_NESTED"),
        "machine",
      );
    },
  );
  ...
  Deno.test(
    "expands environment variables and concats with default nested",
    () => {
      const obj: IObj | undefined = expand(dotenv).parsed;
      assertEquals(
        obj?.DEFINED_EXPAND_WITH_DEFAULT_NESTED_TWICE,
        "machinedefault",
      );
    },
  );
  ...
  Deno.test(
    "expands missing environment variables to an empty string but replaces with default nested",
    () => {
      const obj: IObj | undefined = expand(dotenv).parsed;
  ...
  Deno.test(
    "expands missing environment variables to an empty string but replaces with default nested twice",
    () => {
      const obj: IObj | undefined = expand(dotenv).parsed;
  ...
  Deno.test("should expand recursively", () => {
    const obj: IObj | undefined = expand(dotenv).parsed;
    assertEquals(
      obj?.WITHOUT_CURLY_BRACES_URI_RECURSIVELY,
      "mongodb://username:password@abcd1234.mongolab.com:12345/heroku_db",
    );
  });

  Deno.test(
    "should not write to process.env if ignoreProcessEnv is set",
    () => {
      const dotenv = {
  ...
  Deno.test(
    "expands environment variables existing already on the machine even with a default with special characters",
    () => {
      const obj: IObj | undefined = expand(dotenv).parsed;
      assertEquals(
        obj?.DEFINED_EXPAND_WITH_DEFAULT_WITH_SPECIAL_CHARACTERS,
        "machine",
      );
    },
  );
  ...
  Deno.test("should expand with default value correctly", () => {
    const obj: IObj | undefined = expand(dotenv).parsed;
    assertEquals(
      obj?.UNDEFINED_EXPAND_WITH_DEFAULT_WITH_SPECIAL_CHARACTERS,
      "/default/path:with/colon",
    );
    assertEquals(
      obj?.WITHOUT_CURLY_BRACES_UNDEFINED_EXPAND_WITH_DEFAULT_WITH_SPECIAL_CHARACTERS,
      "/default/path:with/colon",
    );
  });
  ...
  Deno.test("should expand with default nested value correctly", () => {
    const obj: IObj | undefined = expand(dotenv).parsed;
    assertEquals(
      obj?.UNDEFINED_EXPAND_WITH_DEFAULT_WITH_SPECIAL_CHARACTERS_NESTED,
      "/default/path:with/colon",
    );
  });
  ...
  Deno.test("Parse and expand recursive environment variables", () => {
    ...
    assertEquals(
      parsedContent.NNR_A_02,
      "303029282726252423222120191817161514131211109876543",
    );
    assertEquals(
      parsedContent.NNR_A_03,
      "3029282726252423222120191817161514131211109876543",
    );
    assertEquals(
      parsedContent.NNR_A_04,
      "302928272625242322212019181716151413121110987654",
    );
    assertEquals(
      parsedContent.NNR_A_05,
      "30292827262524232221201918171615141312111098765",
    );
    assertEquals(
      parsedContent.NNR_A_06,
      "3029282726252423222120191817161514131211109876",
    );
    assertEquals(
      parsedContent.NNR_A_07,
      "302928272625242322212019181716151413121110987",
    );
    assertEquals(
      parsedContent.NNR_A_08,
      "30292827262524232221201918171615141312111098",
    );
    assertEquals(
      parsedContent.NNR_A_09,
      "3029282726252423222120191817161514131211109",
    );
    assertEquals(
      parsedContent.NNR_A_10,
      "302928272625242322212019181716151413121110",
    );
    assertEquals(
      parsedContent.NNR_A_11,
      "3029282726252423222120191817161514131211",
    );
    assertEquals(
      parsedContent.NNR_A_12,
      "30292827262524232221201918171615141312",
    );
    assertEquals(
      parsedContent.NNR_A_13,
      "302928272625242322212019181716151413",
    );
